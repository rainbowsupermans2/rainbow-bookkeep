...
| 版本 | 日期 | 主要更新 |
|---|---|---|
| v3.24 | 2026/06/03 | sumTaiStockMarketValue：直接 sum 個股 F 欄（不依賴可能過時的「1150421台幣市值」row）|
| v3.23 | 2026/06/03 | dailyAssetUpdate：sum 多帳戶台股 + 移除 F15 硬編碼（修台股市值跑出 159 的 bug）|
